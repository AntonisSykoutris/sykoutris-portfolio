...
export const metadata: Metadata = {
  openGraph: {
    ...
    url: 'https://sykoutris-portfolio-eight.vercel.app/',
    images: [
      {
        url: 'https://sykoutris-portfolio-eight.vercel.app/social.png',
        width: 1200,
        height: 630
      }
    ],
  ...
  return (
    <html lang='en'>
      ...
      <body>
        <SmoothScroll>
          <Navbar />
          <main className='mx-auto flex w-[95svw] flex-col items-center md:w-[90svw] xl:w-[65svw]'>
            {children}
          </main>
          <Footer />
        </SmoothScroll>
