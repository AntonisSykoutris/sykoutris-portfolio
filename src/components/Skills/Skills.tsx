...
export default function Skills({}: Props) {
  return (
    <Section showTopLeftIcon={false} showTopRightIcon={false} className=''>
      ...
      <div className='absolute left-[-1px] top-[-1px] z-10 h-3.5 w-3.5 rotate-0 border-l border-t border-black'></div>
